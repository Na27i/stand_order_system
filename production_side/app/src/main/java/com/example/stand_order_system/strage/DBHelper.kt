...
class DBHelper(context: Context) : SQLiteOpenHelper(context,
    ...
    fun insertOrder(order: OrderModel): Boolean {
        ...
        values.put(DBContract.OrderList.PLANE_NUM, order.planeNum)
        values.put(DBContract.OrderList.SOY_NUM,   order.soyNum)
        values.put(DBContract.OrderList.MEN_NUM,   order.menNum)
        values.put(DBContract.OrderList.PIZZA_NUM, order.pizzaNum)
        values.put(DBContract.OrderList.DEATH_NUM, order.deathNum)
        values.put(DBContract.OrderList.HONEY_NUM, order.honeyNum)
